...
const housingEndpoint = 'https://hqydbvla94.execute-api.eu-central-1.amazonaws.com/prod/predict-house-price';

// Endpoint URL for Named Entity Recognition
const nerEndpoint = 'https://eeh5cy1jm8.execute-api.eu-central-1.amazonaws.com/prod/ner';

// Endpoint URL for PoS tagging and dependency parsing
const parseEndpoint = 'https://olpb5jmptj.execute-api.eu-central-1.amazonaws.com/prod/parse'; 

// S3 bucket name for image uploads
const uploadBucketName = 'resnet50-uploads';
...
const identityPoolId = 'eu-central-1:6ed05d52-f8ba-456f-a9b4-107c8d45cfdd';

// Ednpoint URL for image classification with ResNet50 model
const resnet50Endpoint = 'https://m6vspp8rq3.execute-api.eu-central-1.amazonaws.com/production/classify';

// Endpoint URL for image classification with Inception V3 model
const inceptionV3Endpoint = 'https://ea5llnzukg.execute-api.eu-central-1.amazonaws.com/production/classify';
